<?php /* Smarty version 3.1.27, created on 2016-04-30 04:38:44
         compiled from "E:\wapm56\apache24\htdocs\zyb10\kh_ganrui\vip\templates\qjlr.html" */ ?>
<?php
/*%%SmartyHeaderCode:26996572436d429bf86_45647213%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '677e9f4dd6805b43ec310a467f9253ad9decf4c9' => 
    array (
      0 => 'E:\\wapm56\\apache24\\htdocs\\zyb10\\kh_ganrui\\vip\\templates\\qjlr.html',
      1 => 1461416497,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26996572436d429bf86_45647213',
  'variables' => 
  array (
    'list' => 0,
  ),
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_572436d4a0a507_76481676',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_572436d4a0a507_76481676')) {
function content_572436d4a0a507_76481676 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '26996572436d429bf86_45647213';
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>乐天游乐场售票系统-期间注册</title>
...
//--------票种处理---------      
    ...
    //下面为提示信息
    messages: {
      txtloginname: {required: "期间不能为空!",minlength: "期间长度至少是 2 。",maxlength: "期间超过允许的最大长度（50）。"},
      txtPassword: {required: "建议加入备注信息!",minlength: "备注长度至少是6位!",maxlength: "最长是100位!"},
      txtcheckpassword: {required: "重复密码不能为空!",minlength: "重复密码长度至少是6位!", maxlength: "重复密码长度最长是16位!",equalTo:"两次输入的密码不相同!"},
      yd631_age: {number: "折扣比率应该为数字!",min:"最小（1）!",max:"最大（最大100）!"},
...
//用户名称验证
 ...
 $.ajax({
    url: "member57_qjlr.php",     //提交的动态页面地址
...
//-------------------------------------------------
    ...
    success: function(data){
      if ('0'==data) {/*没有被注册*/
        $("#loginname_sign").html("<span style='color:green;line-height:30px;'>恭喜您，期间名可以使用</span>");
      }else if ('1'==data) {/*已经被注册*/
        $("#loginname_sign").html("<span style='color:red;line-height:30px;'>期间名已被注册</span>");
      }else {/*条件不对*/
...
<body>
  ...
  <div id="contain">
    <form class="cmxform" id="form_regist" method="post" action="index.php?action=reg_save_qjlr">
    ...
    <div class="w700 form_part_1">
      ...
      <div class="w700 part_1_con">
        ...
        <ul>
			  ...
			  <span id="loginname_sign" class="in_info">3-50个字符（包含小写字母、数字、下划线、中文），最多使用5个汉字，推荐使用中文期间名，一旦注册成功期间名不能修改。</span></li>
		      <li><input class="in" name="yd631_age" type="text" id="yd631_age" /><span class="in_info" style="line-height:30px;">请输入期间折扣比率（如90、95）。</span></li>
			  <li style=""><input class="in" name="txtPassword" type="text" id="yd631_pws1" /><span class="in_info">备注除中文外可以是任意的英文字符、数字或符号。
			  </span></li>	 
			  <li><span class="in_info" style="line-height:30px;"><a href="./index.php?action=hygl">退出</a></li></span></li>
			  <!-- 
...
-->
          ...
          <div style="clear:both"></div>
            <div class="w700 btn">
               <input type="submit" name="Submit" id="tj">
		    </div>

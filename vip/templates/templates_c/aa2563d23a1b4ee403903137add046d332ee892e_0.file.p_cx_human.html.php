<?php /* Smarty version 3.1.27, created on 2016-04-23 13:02:34
         compiled from "E:\wapm56\apache24\htdocs\zyb10\kh_ganrui\vip\templates\p_cx_human.html" */ ?>
<?php
/*%%SmartyHeaderCode:19761571b726a78d983_46701852%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa2563d23a1b4ee403903137add046d332ee892e' => 
    array (
      0 => 'E:\\wapm56\\apache24\\htdocs\\zyb10\\kh_ganrui\\vip\\templates\\p_cx_human.html',
      1 => 1461416495,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19761571b726a78d983_46701852',
  'variables' => 
  array (
    'username' => 0,
    'user_name' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_571b726be57e07_28700921',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_571b726be57e07_28700921')) {
function content_571b726be57e07_28700921 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '19761571b726a78d983_46701852';
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>乐天游乐场售票系统-自定义查询条件设定（售票员：<?php echo $_smarty_tpl->tpl_vars['username']->value;?>
）</title>
...
<form class="cmxform" id="form_regist" method="post" action="center.php?action=p_cx_human_cx">
<table width="100%">
	<tr align="center" >
		<td align="center"> <strong>乐天游乐场售票系统-查询条件设定   （<?php echo $_smarty_tpl->tpl_vars['user_name']->value;?>
）</strong>||<a href="center.php"> 返   回   </a></td>
	</tr>
</table>
...
<tr bgcolor="#CCCCCC">       
	<td width="15%" align="right">售票张数》= </td>
	<td width="85%" align="left"><input class="in" name="txtzs_1" type="text" id="txtzs_1" value = "" /><span class="in_info">必须为数字。 </span></td>
	<td  align="left"></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
<tr bgcolor="#CCCCCC">       
	<td width="15%" align="right">售票张数《= </td>
	<td width="85%" align="left"><input class="in" name="txtzs_2" type="text" id="txtzs_2" value = "" /><span class="in_info">必须为数字。 </span></td>
	<td  align="left"></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
<tr bgcolor="#CCCCCC">       
	<td width="15%" align="right">应收金额》= </td>
	<td width="85%" align="left"><input class="in" name="txtysje_1" type="text" id="txtysje_1" /><span class="in_info" style="line-height:30px;">必须为数字。</span></td>
	<td  align="left"></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
<tr bgcolor="#CCCCCC">       
	<td width="15%" align="right">应收金额《= </td>
	<td width="85%" align="left"><input class="in" name="txtysje_2" type="text" id="txtysje_2" /><span class="in_info" style="line-height:30px;">必须为数字。</span></td>
	<td  align="left"></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
<tr bgcolor="#CCCCCC">       
	<td width="15%" align="right">实收金额》= </td>
	<td width="85%" align="left"><input class="in" name="txtssje_1" type="text" id="txtssje_1" /><span class="in_info" style="line-height:30px;">必须为数字。</span></td>
	<td  align="left"></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
<tr bgcolor="#CCCCCC">       
	<td width="15%" align="right">实收金额《= </td>
	<td width="85%" align="left"><input class="in" name="txtssje_2" type="text" id="txtssje_2" /><span class="in_info" style="line-height:30px;">必须为数字。</span></td>
	<td  align="left"></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
<tr bgcolor="#CCCCCC">       
	<td width="15%" align="right">找零》= </td>
	<td width="85%" align="left"><input class="in" name="txtzl_1" type="text" id="txtzl_1" /><span class="in_info" style="line-height:30px;">必须为数字。</span></td>
	<td  align="left"></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
<tr bgcolor="#CCCCCC">       
	<td width="15%" align="right">找零《= </td>
	<td width="85%" align="left"><input class="in" name="txtzl_2" type="text" id="txtzl_2" /><span class="in_info" style="line-height:30px;">必须为数字。</span></td>
	<td  align="left"></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
...
<tr align="center" bgcolor="#CCCCCC">
	...
	<td  align="center"><a href="center.php">返回 </a></td>
	<td  align="left"></td>
	<td align="left"></td>
</tr>
</table>

<?php /* Smarty version 3.1.27, created on 2016-04-30 04:38:27
         compiled from "E:\wapm56\apache24\htdocs\zyb10\kh_ganrui\vip\templates\pzlr.html" */ ?>
<?php
/*%%SmartyHeaderCode:5656572436c3d4e404_01561607%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b27ef6f4d97b11e856ef1ab84cc0e36bf65471a5' => 
    array (
      0 => 'E:\\wapm56\\apache24\\htdocs\\zyb10\\kh_ganrui\\vip\\templates\\pzlr.html',
      1 => 1461416497,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5656572436c3d4e404_01561607',
  'variables' => 
  array (
    'list' => 0,
  ),
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_572436c4d69982_86785321',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_572436c4d69982_86785321')) {
function content_572436c4d69982_86785321 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '5656572436c3d4e404_01561607';
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>乐天游乐场售票系统-票种注册</title>
...
//--------票种处理---------      
    ...
    //下面为提示信息
    messages: {
      txtloginname: {required: "票种不能为空!",minlength: "票种长度至少是 2 。",maxlength: "票种超过允许的最大长度（50）。"},
      ...
      yd631_age: {number: "单价应该为数字!",min:"最小（1.00）!",max:"最大（最大10000.00）!"},
...
//用户名称验证
 ...
 $.ajax({
    url: "member57_pzlr.php",     //提交的动态页面地址
...
//-------------------------------------------------
    ...
    success: function(data){
      if ('0'==data) {/*没有被注册*/
        $("#loginname_sign").html("<span style='color:green;line-height:30px;'>恭喜您，票种名可以使用</span>");
      }else if ('1'==data) {/*已经被注册*/
        $("#loginname_sign").html("<span style='color:red;line-height:30px;'>票种名已被注册</span>");
      }else {/*条件不对*/
...
<body>
  ...
  <div id="contain">
    <form class="cmxform" id="form_regist" method="post" action="index.php?action=reg_save_pzlr">
    ...
    <div class="w700 form_part_1">
      ...
      <div class="w700 part_1_con">
        ...
        <ul>
			  ...
			  <span id="loginname_sign" class="in_info">3-50个字符（包含小写字母、数字、下划线、中文），最多使用5个汉字，推荐使用中文票种名，一旦注册成功票种名不能修改。</span></li>
		      <li><input class="in" name="yd631_age" type="text" id="yd631_age" /><span class="in_info" style="line-height:30px;">请输入票种单价。</span></li>
